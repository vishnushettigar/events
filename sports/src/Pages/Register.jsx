...
const Register = () => {
  ...
  const validateForm = async () => {
    ...
    if (formData.aadhaar.trim() && /^[0-9]{12}$/.test(formData.aadhaar)) {
      try {
        ...
        if (data.exists) {
          newErrors.aadhaar =
            "This Aadhaar number is already registered. Please use a different Aadhaar number or try logging in.";
        }
      } catch (error) {
  ...
  return (
    <div className="relative min-h-screen lg:h-screen w-full flex flex-col lg:flex-row overflow-y-auto lg:overflow-hidden bg-white">
      ...
      {/* Column 1: Image (Fixed, hidden on mobile and tablet) */}
      <div className="hidden lg:block lg:w-1/2 h-full relative select-none bg-slate-900 flex-shrink-0">
        <img
          src={loginImg}
          alt="Sports Festival Register"
      ...
      {/* Column 2: Form (Scrollable container if overflowing) */}
      <div className="w-full lg:w-1/2 h-full lg:overflow-y-auto flex flex-col justify-start items-center p-4 pt-20 lg:p-12 lg:py-16 bg-white">
        <div className="w-full max-w-2xl mx-auto py-4 lg:py-8">
          {/* Header Section */}
          <div className="text-center md:text-start mb-6 lg:mb-8">
          ...
          {/* Registration Form (No card borders/shadows/bg on mobile, clean styled layout) */}
            ...
            <form onSubmit={handleContinue} className="space-y-6">
              ...
              <div>
                <button
                  ...
                  style={{
                    backgroundColor:
                      isSubmitting || isValidating ? "#9CA3AF" : "#D35D38",
                  }}
                  className="w-full py-4 px-6 rounded-lg font-bold text-lg shadow-lg transition-all duration-200 text-white transform hover:scale-105 active:scale-98 hover:brightness-95"
                >
                  {isSubmitting ? (
                ...
                {(isEnglish ? rules : rulesKannada).map((rule, idx) => {
                          ...
                          <table className="w-full border-collapse border border-gray-400 bg-white rounded-lg shadow-sm text-xs sm:text-sm">
                            ...
                            <tbody>
                              <tr className="hover:bg-gray-50">
                                ...
                                <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-center font-bold text-green-600 text-xs sm:text-sm">
                                  5
                                </td>
                                <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-center font-bold text-blue-600 text-xs sm:text-sm">
                                  3
                                </td>
                                <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-center font-bold text-orange-600 text-xs sm:text-sm">
                                  1
                                </td>
                              </tr>
                              <tr className="hover:bg-gray-50">
                              ...
                              <tr className="hover:bg-gray-50">
                                ...
                                <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-center font-bold text-gray-400 text-xs sm:text-sm">
                                  –
                                </td>
                              </tr>
                              <tr className="hover:bg-gray-50">
                  ...
                  return (
                    <div key={idx} className="flex items-start gap-3">
                      <span className="inline-block mt-1 text-[#D35D38] text-xl font-bold">
                        •
                      </span>
            ...
            <div className="bg-gray-50 p-4 sm:p-6 border-t flex-shrink-0">
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="flex items-start gap-2 sm:gap-3">
                  ...
                  <label
                    htmlFor="acceptRules"
                    className="text-xs sm:text-sm text-[#2A2A2A] leading-relaxed"
                  >
                    {isEnglish
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
                  ...
                  <button
                    ...
                    className="w-full sm:flex-1 py-3 px-4 sm:px-6 bg-[#D35D38] hover:bg-[#B84A2E] text-white rounded-lg font-bold transition-all duration-200 text-sm sm:text-base transform  active:scale-99 cursor-pointer"
                  >
                    {isSubmitting ? (
                      <span className="flex items-center justify-center">
                        <svg
