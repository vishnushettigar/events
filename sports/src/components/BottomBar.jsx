  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-[#F8DFBE] z-50 md:hidden ">
      <div className='w-[95%] mx-auto'>
        ...
        {/* Individual Events with Notification - CLEANED UP */}
        <Link
          to="/myevents/templeparticipants"
          // Added 'relative' to the Link itself for easier badge positioning
        ...
        >
          ...
          <div className="relative">
            ...
            {pendingCount > 0 && (
              ...
              <span className="absolute -top-1 -right-2 bg-[#D35D38] text-white text-xs font-bold w-4 h-4 rounded-full flex items-center justify-center">
                {isLoading ? (
                  ...
                  // Truncate to '99+' if count is too high
