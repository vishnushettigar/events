...
const Footer = () => {
  return (
    <footer className="w-full bg-[#FCFCFC] relative overflow-hidden">
      {/* Subtle check square grid pattern fading from the bottom */}
      <div
        className="absolute inset-0 pointer-events-none z-0"
        style={{
          backgroundImage: `
            linear-gradient(to bottom, rgba(252, 252, 252, 1) 0%, rgba(252, 252, 252, 0) 100%),
            linear-gradient(to right, rgba(0, 0, 0, 0.035) 1px, transparent 1px),
            linear-gradient(to top, rgba(0, 0, 0, 0.035) 1px, transparent 1px)
          `,
              ...
              <div className="flex flex-row items-center gap-2">
                ...
                <div className="flex flex-col">
                  ...
                  <a
                    ...
                    href="https://www.instagram.com/salikerifriendsclub"
                    target="_blank"
